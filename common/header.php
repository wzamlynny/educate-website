  ...
  <div class='menu_area'>
    <nav class='navbar navbar-default navbar-fixed-top' role='navigation'>  <div class='container'>
        <div class='navbar-header'>
          ...
          <!-- TEXT BASED LOGO -->
          <a class='navbar-brand' href=<?php echo "'" . $root . "'"; ?> >Educate the <span>Future</span></a>              
        ...
        <div id='navbar' class='navbar-collapse collapse'>
          <ul id='top-menu' class='nav navbar-nav navbar-right main-nav'>
            ...
            <!-- TODO: FIX THE ACTIVE HEADER -->
            <li><a href=<?php echo "'" . $root . "'"; ?>>Home</a></li>
            <li><a href=<?php echo "'" . $root . "courses/course-archive.php'"; ?>>Courses</a></li>
            <li>
              <a href=<?php echo "'" . $root . "scholarship'"; ?>'scholarship'>Scholarship</a>
            </li>
            <li><a href=<?php echo "'" . $root . "events/events-archive.php'"; ?>>Events</a></li>
